...
# Groq deprecated "llama-3.1-8b-instant" (announced June 17, 2026).
# Their recommended replacement is "openai/gpt-oss-20b".
# If you ever hit a model_decommissioned / NotFoundError again, check
# https://console.groq.com/docs/deprecations and swap the model string below.
